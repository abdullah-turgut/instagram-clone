...
export default function Navbar() {
  return (
    <>
      <div className="fixed bottom-0 w-screen h-14 border-t border-gray-300 flex gap-y-4 items-center justify-evenly md:static md:border-none md:mb-5 md:w-12 md:flex-col md:h-full xl:items-stretch xl:w-full bg-white">
