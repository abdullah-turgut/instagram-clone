...
export default function Header() {
  return (
    <div className="flex flex-col gap-y-4 md:pt-2 md:px-3 md:h-screen md:border-r md:border-gray-300">
      <div className="flex items-center justify-between sticky px-4 md:p-0 h-[60px] w-screen top-0 border-b border-gray-300 md:relative md:flex-col md:w-auto md:h-[92px]   md:justify-center md:items-center md:border-none xl:w-[220px]">
        <Link
          href="/"
